...
epoch_list = list(range(310, 350, 10)) + list(range(360, 370, 10))  # 24.09.25 SDDB-1
# epoch_list = list(range(350, 750, 50))  # 24.09.19 HKDB-1 test에 맞춰 변경함

for epoch in epoch_list:
    score_path1 = f'D:/DION4FR/mask_change/output/SDdb-1/foreer/epoch_{epoch}/3test.csv'  # 24.09.19 HKDB-1 test에 맞춰 변경함
    ...
    print(epoch, ":", EER)
    with open(f'D:/DION4FR/mask_change/output/SDdb-1/foreer/epoch_{epoch}/3test_test_result_EER.txt', 'a+') as result:  # 24.09.19 HKDB-1 test에 맞춰 변경함
