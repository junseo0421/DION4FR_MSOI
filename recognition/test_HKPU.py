...
args.csvpath = 'Datasets/DS_TEST_bad(B)/'
args.origin_path = 'Datasets/images/t2_kj/'
args.test_path = 'Datasets/images/SNDCR_HKPU_B_shift_ver2/'
args.savepath = 'Output/HKPU_B/foreer/'
args.savenm = 'test.csv'
args.savenm_total = 'testrttt.csv'
args.model_path = 'Output/HKPU_B/checkpoints/'
